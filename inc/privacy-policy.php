                        ...
                        <div class="row">
                            <div class="site-branding">
                                <a href="<?php echo SITE_URL?>home" class="custom-logo-link" rel="home">
                                    <img src=" <?php echo IMAGES_URL ?>logo.png" style="height: 75px; width: auto; background-size: cover">
                                </a>
                                <!-- /.custom-logo-link -->
                            </div>
                            <!-- /.site-branding -->
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                        <a title="About us" href="pages/?p=about-us">About LeafPlus</a>
                                    </li>
...
?>         	
<div class="container">
	<h2><?php echo $page_info[2]->title ?></h2>
	<h3><?php echo $page_info[2]->summary ?></h3>
	<p><?php echo strip_tags($page_info[2]->description) ?></p>
</div>
